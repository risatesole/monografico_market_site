...
def signIn(request): return HttpResponse("Sign In page")
def signUp(request): return HttpResponse("sign Up page")
def signOut(request): return HttpResponse("Sign Out page")
